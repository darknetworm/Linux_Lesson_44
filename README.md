...
На основном сервере проверяем существующие БД, в том числе присутствие БД *"otus"* с записями, произвденными в процессе настройки стенда с помощью Ansible. Создаем тестовую БД *"otus_test"*.  
