...
Для проверки репликации необходимо подключиться к СУБД PostgreSQL на основном сервере и сервере репликации (пароль администратора - ***"Otus2022!"*** задается в процессе настройки серверов).  
